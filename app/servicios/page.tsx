  ...
  return (
    <div className="w-full h-full bg-gray-100 dark:bg-gray-800 px-4 py-8 md:py-16">
      <div className="mb-6 text-xl text-gray-700 dark:text-white mx-auto max-w-2xl text-center lg:w-3/4 xl:w-1/2">
        <h3 className="text-center text-white font-bold uppercase animate-pulse animate-infinite animate-duration-[100ms] animate-delay-[44ms] animate-ease-out -mt-28 prose prose-xl prose-slate dark:prose-invert">
