...
export default async function Post({ params }: { params: { postId: string } }) {
  ...
  return (
    <main className="mt-14 w-9/12 flex gap-4 mx-auto " >
      <div className=" mr-2 flex flex-col w-full prose-headings:dark:text-white  mx-auto prose prose-headings:font-bold prose-headings:text-3xl prose-headings:my-4 dark:text-white text-gray-800">
