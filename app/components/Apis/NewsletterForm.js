...
const NewsletterForm = ({ status, message, onValidated }) => {
  ...
  return (
    <div
      className="mb-10 px-6 sm:px-1 bg-banner text-white text-start mx-auto max-w-[98ch] p-10 border-gray-600 border rounded-2xl"
      style={{
    ...
    >
      ...
      <p className="text-lg font-bold text-yellow-500 mb-4"></p>
